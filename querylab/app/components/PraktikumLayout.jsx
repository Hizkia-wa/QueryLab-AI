    ...
    <div style={{ backgroundColor: "#F8FAFC", minHeight: "100vh" }}>
      ...
      <nav className="navbar border-bottom bg-white px-4 sticky-top shadow-sm py-3">
        <div className="container-fluid">
          <Link href="/" className="navbar-brand fw-bold text-primary d-flex align-items-center gap-2">
          ...
          <div className="ms-auto d-flex align-items-center gap-3">
            ...
            <Link href="/modul" className="btn btn-outline-dark btn-sm rounded-pill px-3">Keluar</Link>
          </div>
        </div>
      </nav>

  ...
  if (filteredQuiz.length === 0) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#f8fafc]">
        ...
        <button onClick={() => router.back()} className="mt-4 btn btn-primary rounded-pill px-4">Kembali</button>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#f8fafc] flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-white p-6 md:p-10 rounded-[2.5rem] shadow-sm border border-gray-100">
        ...
        <div className="d-flex justify-content-between align-items-center mb-5">
          <button onClick={() => router.back()} className="btn btn-light rounded-circle p-2"><ChevronLeft size={20} /></button>
